...
var server = http.createServer(function(req, res) {
  ...
  form.parse(req, function (err, fields, files) {
    ...
    assert.strictEqual(files['relative_path'].name, relativePath + '/' + options.filename, 'Expects filename with relative path');
...
server.listen(common.port, function() {
  ...
  form.append('relative_path', fs.createReadStream(unknownFile), {filename: options.filename, relativePath: relativePath});
